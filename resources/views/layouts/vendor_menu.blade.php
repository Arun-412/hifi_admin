<?php
	function dynamicActiveLink($path){
		$path_config = array(
			'dashboard'		=> array('vendor/dashboard'),
            'dmt'		=> array('vendor/dmt'),
            'user'		=> array('vendor/user'),
            'report'		=> array('vendor/report'),
		);
